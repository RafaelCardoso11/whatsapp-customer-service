...
export const CommandsWithDescription = {
  ...
  [Command.CloseChatGPT]: 'O consultor poderá fechar o auxílio com o ChatGPT *(Em Breve)*',
  [Command.ActivateAIAssistance]: 'Ativa o modo atendimento por IA *(Em Breve)*',
  [Command.DeactivateAIAssistance]: 'Fecha o modo atendimento por IA *(Em Breve)*',
};
